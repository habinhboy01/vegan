...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_directory') ?>/css/organizer.css">
            ...
            <div class="d-flex flex-column flex-grow-1 align-items-center organizer-container">
                ...
                <div class="d-flex flex-column align-items-center w-100">
                    ...
                    <div class="d-flex justify-content-evenly align-items-center w-100 mb-5 organizer-bottom">
                        <?php 
                        $image = get_field('logo-organizer4');
                        if( !empty( $image ) ): ?>
                            <img class="organizer-logo" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                        <?php endif; ?>

                        <?php 
                        $image = get_field('logo-organizer5');
                        if( !empty( $image ) ): ?>
                            <img class="organizer-logo" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                        <?php endif; ?>

                        <?php 
                        $image = get_field('logo-organizer6');
                        if( !empty( $image ) ): ?>
                            <img class="organizer-logo" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                        <?php endif; ?>
                    </div>
